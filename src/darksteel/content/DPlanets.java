...
DPlanet.cloudMeshLoader = () -> new MultiMesh(
        ...
        new ParticleRingMesh(DPlanet, 2.07f, 512, Color.valueOf("#a0bde8"), false),
        new ParticleRingMesh(DPlanet, 2.08f, 512, Color.valueOf("#a7c4ec"), false),
        new ParticleRingMesh(DPlanet, 2.09f, 512, Color.valueOf("#adc9ef"), false),
        new ParticleRingMesh(DPlanet, 2.13f, 512, Color.valueOf("#b3cde3"), false),
        new ParticleRingMesh(DPlanet, 2.14f, 512, Color.valueOf("#b8c8e2"), false),
        new ParticleRingMesh(DPlanet, 2.12f, 512, Color.valueOf("#b8c8e2"), false),
        new ParticleRingMesh(DPlanet, 2.15f, 512, Color.valueOf("#bed2e7"), false),
